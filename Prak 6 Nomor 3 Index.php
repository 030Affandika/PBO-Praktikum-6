...
<?php 
    require_once 'Prak 6 Nomor 3.php';
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-5 mx-auto border p-3 mt-2">
                <h4 class="text-center"><strong><u>Nomor 3</u></strong></h4>
                <br><br>
                <?= $burung->eat(); ?> <br>
                <?= $manusia->eat(); ?> <br>
                <br>
                ...
                <?php 
                        echo "Banyak bahan bakar yang dibutuhkan adalah " . $airplane2->calcFuelNeeds() . ' Liter'. '<br>';
                    ?>
                <br>
                <?= $superman2->eat(); ?> <br>
                <?= $superman2->land(); ?> <br>
