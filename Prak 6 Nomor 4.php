...
require_once 'Prak 6 Nomor 4 Abstract.php';
require_once 'Prak 6 Nomor 4 Interface.php';
...
$riverBarge2 = new RiverBarge2(31000, 'Atomic');
$seaPlane = new SeaPlane(25000, 'Titanic');
$helicopter = new Helicopter(13000, 'Brocklyn');